...
|----------|-----------|-----------|------|
| **Groq** | 500K tokens/day | ⚡ Sangat Cepat | [console.groq.com](https://console.groq.com/keys) |
...
| **Language** | Python 3.8+ |
| **Framework** | Streamlit |
| **AI Engine** | Multi-provider (Gemini/Groq) + Demo Mode |
...
| **Library** | streamlit, PyPDF2, google-generativeai/groq (optional) | 13-15 |
